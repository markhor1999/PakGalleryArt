...
public class FollowersActivity extends AppCompatActivity {
    ...
    private DatabaseReference UsersRef, FollowersRef;
    ...
    {
        options = new FirebaseRecyclerOptions.Builder<FriendsModel>().setQuery(FollowersRef, FriendsModel.class).build();
            ...
            protected void onBindViewHolder(@NonNull final FriendsViewHolder holder, final int position, @NonNull FriendsModel model) {
                ...
                UsersRef.child(FriendsIds).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists())
                        {
                            ...
                            Glide.with(FollowersActivity.this).load(profileImage).placeholder(R.drawable.profile).into(holder.mProfileImage);
                        }
                    }
                    @Override
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent ChatActivity = new Intent(FollowersActivity.this, ChatActivity.class);
